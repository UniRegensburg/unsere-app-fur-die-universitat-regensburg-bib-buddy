...
public class NoteDAO implements INoteDAO {
  ...
  public boolean create(Note note) {
    ...
    try (SQLiteDatabase db = dbHelper.getWritableDatabase()) {
      ...
      Cursor c =
          db.query(DatabaseHelper.TABLE_NAME_NOTE_FILE, null, null, null, null, null, null);
      c.moveToLast();
  ...
  public Note findById(long id) {
    ...
    Cursor cursor = db.query(DatabaseHelper.TABLE_NAME_NOTE, new String[] {
        DatabaseHelper._ID, DatabaseHelper.NAME, DatabaseHelper.TYPE, DatabaseHelper.TEXT,
  ...
  /**
   * Update a specific note-object in the database.
   */
