...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
  ...
  /**
   * RecyclerViewAdapter is a custom adapter for RecyclerListView.
   *
   * @param data     base data gained from the RecyclerView
   * @param activity base activity of the fragment
   */
  ...
  public static class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    /**
     * Constructor for a custom ViewHolder for RecyclerViewList-items.
     *
     * @param itemView View of each RecyclerViewList-item.
     */
    public MyViewHolder(View itemView) {
      super(itemView);
      title = itemView.findViewById(R.id.noteTitle);
      modDate = itemView.findViewById(R.id.noteModDate);
      typeIcon = itemView.findViewById(R.id.noteType);
    }
